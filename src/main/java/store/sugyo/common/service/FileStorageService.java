package store.sugyo.common.service;
...
import store.sugyo.common.domain.ImageFileExtension;
import store.sugyo.common.exception.ApplicationException;
import store.sugyo.common.repository.ObjectStorageRepository;

import java.io.IOException;
import java.io.InputStream;
import java.util.UUID;

import static store.sugyo.common.exception.CommonErrorCode.*;
